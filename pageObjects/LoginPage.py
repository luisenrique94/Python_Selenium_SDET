class LoginPage():
    ...
    def setUserName(self, username):
        self.driver.find_element_by_id(self.textbox_userna_id).clear()
        self.driver.find_element_by_id(self.textbox_userna_id).send_keys(username)
